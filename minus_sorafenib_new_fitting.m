function [Raf1fracparam,T,Y,yinit,param, allNames, allValues] = minus_sorafenib_new_fitting(argRaf1_param,argTimeSpan,argYinit,argParam)
...
if nargin >= 1
    Raf1_params = argRaf1_param;
    param(18) = Raf1_params(1); %kR1f
    param(14) = Raf1_params(2); %kR1r
end
