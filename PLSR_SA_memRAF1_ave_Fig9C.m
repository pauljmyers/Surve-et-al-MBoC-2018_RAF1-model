...
parfor count = 1:number
    ...
    new_ave = simpsons(Raf_pm,Tnew)./(Tnew(end) - Tnew(1));    % calculate time-averaged value
    my_y(count) = new_ave;
    percent_change = abs(new_ave - old_ave) / old_ave * 100;
