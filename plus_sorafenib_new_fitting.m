function [RAF1frac,T,Y,yinit,param, allNames, allValues] = plus_sorafenib_new_fitting(Raf1frac_param,argTimeSpan,argYinit,argParam)
...
param = [
	...
	0.1111979829508869;		% param(48) is 'kiR1r'
	...
	1.5204365E-6;		% param(53) is 'kiR1f'
	...
	0.024568432613784427;		% param(128) is 'kfpR1r'
...
if nargin >= 1
    Raf1param = Raf1frac_param;
    param(53) = Raf1param(1); %kiR1f
    param(48) = Raf1param(2); %kiR1r
    param(128) = Raf1param(3); %kfpR1r
