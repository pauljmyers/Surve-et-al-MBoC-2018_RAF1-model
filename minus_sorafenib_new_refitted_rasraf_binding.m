function [RasGTPparam,T,Y,yinit,param, allNames, allValues] = minus_sorafenib_new_refitted_rasraf_binding(argGTPRas_param,argTimeSpan,argYinit,argParam)
...
if nargin >= 1
    ...
    param(112) = GTPRas_param(1); %A
    param(111) = GTPRas_param(2); %B
    param(110) = GTPRas_param(3); %C
    param(109) = GTPRas_param(4); %D
end
...
function rowValue = getRow(t,y,y0,p)
	...
	Raf1_pm_param = (Ras_pRaf1 + (2.0 .* Ras_pRaf1_Raf1_tetramer) + Ras_BRaf_Raf1_tetramer + Ras_iRaf1 + Ras_Raf1 + (2.0 .* Ras_iRaf1_tetramer) + (2.0 .* Ras_iRaf1_Raf1_tetramer) + Ras_Braf_iRaf1_tetramer + (2.0 .* Ras_iRaf1_pRaf1_tetramer) + Ras_BRaf_pRaf1_tetramer + (2.0 .* Ras_pRaf1_tetramer) + Ras_nfpiRaf1 + Ras_nfpRaf1 + Ras_iRaf1_iBRaf1_tetramer);
